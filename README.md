Scripts to apply patches to [turbo-fieldfare-fork](https://github.com/dorigoa/turbo-fieldfare-fork) (which is a fork from https://github.com/drumih/turbo-fieldfare).
